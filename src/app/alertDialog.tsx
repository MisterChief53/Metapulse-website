  ...
  export function AlertDialogDemo({ buttonText, idItem }) {
    ...
    return (
      ...
      <span className="text-white text-6xl font-bold">✅</span>
        ...
        <AlertDialogContent className="bg-backgroundBlue border-2 border-blue-500 shadow-lg hover:shadow-blue-700 boxShadow = '0px 0px 15px 7px rgba(0, 0, 255, 0.5)'">
        <AlertDialogHeader>
          <AlertDialogTitle className="text-white text-xl">Error in purchase</AlertDialogTitle>
        </AlertDialogHeader>
            <AlertDialogDescription className="text-white text-sm">There was an error processing your purchase. Please try again.</AlertDialogDescription>
          
        
          <AlertDialogFooter>
          <AlertDialogCancel className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800"
          onClick={() => setModalErrorAbierto(false)}>Close</AlertDialogCancel>
          </AlertDialogFooter>
          </AlertDialogContent>
        </AlertDialog>
      </>
